    ...
    if (this.props.events.length !== 0) {
      ...
      this.props.events.forEach(async el => {
        ...
        if (artist.length === 1) {
          ...
          await this.setState({
            bookedArtistInfo: this.props.selectedEvent['event'],
          });
        }
      });
    }
        ...
        <IonContent>
          ...
          <div className="profile">
            ...
            this.state.localStatus !== 'declined' ? (
              ...
              <IonCardSubtitle style={{ color: 'black', fontSize: '15.5px' }}>
                This artist is {this.props.bookingStatus['status']} for{' '}
                {this.state.bookedArtistInfo['name']} at{' '}
                {this.state.bookedArtistInfo['venueName']}.
              </IonCardSubtitle>
            ) : null}
            {this.props.events !== undefined &&
            this.props.events.length !== 0 ? (
