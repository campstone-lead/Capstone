...
console.log(this.props,this.props.userId!==undefined,)
  ...
  <IonTabButton tab="tab3" href={(this.props.userId!==undefined)?'/profile':(this.props.userId!==undefined)?'/profile':'/profile'}>
  <IonIcon icon={(this.props.userId!==undefined)?contact:logIn} />
  <IonLabel>{(this.props.userId!==undefined)?'Profile':'Log In'}</IonLabel>
</IonTabButton>:null
