...
render(){
  if(this.state.loaded===false) return <IonTitle>Loading...</IonTitle>
// if(this.props.userId!==undefined)
// console.log('yes',this.props)
// else console.log('no',this.props)
  return(
  <IonApp>
    <IonReactRouter>
      <IonTabs>
        ...
        <IonTabBar slot="bottom">
          ...
          {(this.props.userId!==undefined)? <IonTabButton tab="tab2" href='/profile'>
            <IonIcon icon={logOut} />
