        ...
        <IonContent>
            ...
            <IonContent>
                    ...
                    <IonToolbar className="tabHeader" >
                        <div className="tabHeader">
                            <img
                                ...
                                className="logo"
                            />
                            <IonCardTitle> Discover. Book .Connect.</IonCardTitle>
                        </div>
                    </IonToolbar>
                ...
                <IonCard className="profile" mode='ios'>
                    ...
                    <IonCardSubtitle>Bookers can quickly discover and connect with artists through our recommendation engine, finding artists by distance and artistic style. Artists can also discover venues and the bookers to connect with instead of needlessly scouring the web. LEAD's job board for musicians is a simple and effective solution towards making everyone's life easier.</IonCardSubtitle>
                </IonCard>
