...
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar,IonSearchbar,IonItem,IonInput,IonLabel,IonButton, IonCard,IonImg, IonItemGroup, IonCardContent, IonCardHeader, IonCardTitle } from '@ionic/react';
import './Tab1.css';
