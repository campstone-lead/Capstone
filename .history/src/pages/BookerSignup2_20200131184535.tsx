...
// const API_KEY='AIzaSyBN_IKIZLzMfhPcu28VhP8u_SslBKWh-iE';
...
<script id='google' src="https://maps.googleapis.com/maps/api/js?key=  AIzaSyBN_IKIZLzMfhPcu28VhP8u_SslBKWh-iE&libraries=places&language=en"></script>
      <IonHeader >
        <IonToolbar id="bar" >
