  ...
  return (
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <IonItem lines="inset">
        ...
        <br></br>
        <IonButton href="/signup0" style={{"width":"270px","margin":"10px"}} >Sign up</IonButton>
        <IonButton  style={{"width":"270px","margin":"10px"}} color="danger">Sign up with Google</IonButton>
        <IonButton  style={{"width":"270px","margin":"10px"}} color="tertiary">Sign up with Facebook</IonButton>
        </div>
      </IonCard>
      </IonContent>
    </IonPage>
