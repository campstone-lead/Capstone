  ...
  return (
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <IonItem>
        ...
        <IonButton href="/signup0" style={{"width":"250px"}} >Sign up</IonButton>
        <IonButton href="/signup0">Sign up with Google</IonButton>
        <IonButton href="/signup0">Sign up with Facebook</IonButton>
        </div>
      </IonCard>
      </IonContent>
    </IonPage>
