  ...
  return (
    ...
    <form onSubmit={this.handleSubmit}>
      <IonItem>
        ...
        onIonChange={(e) => this.handleChange((e.target as HTMLInputElement).value,'name')}
        />
      ...
      <IonItem>
        ...
        <IonInput type="password" placeholder="Password" required
          ...
          onIonChange={(e) => this.handleChange((e.target as HTMLInputElement).value,'password')}
        />
      </IonItem>
