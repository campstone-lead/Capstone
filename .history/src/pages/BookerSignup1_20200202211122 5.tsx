  ...
  return (
    ...
    <IonCard className="welcome-card">
      ...
      <br></br>
        ...
        <IonButton href={'/booker/signup/2'} disabled={(this.state.email.length===0||this.state.firstName.length===0||this.state.password.length===0||this.state.lastName.length===0||this.state.phone.length===0)?true:false} >Next</IonButton>
        </form>
...
const mapDispatchToProps=(dispatch)=>({
  updateBooker:(data)=>dispatch(updateBooker(data))
})
