        ...
        <IonContent>
          ...
          <div className="profile">
            ...
            <IonButton onClick={async () => await this.handleClick()} disabled={(this.state.localStatus.length === 0) ? false : true}>
              {(this.props.bookingStatus === null) ? (this.state.localStatus.length === 0) ? 'Book me' : (this.props.bookingStatus['status'] === 'pending' || this.state.localStatus === 'pending' ? 'Pending request sent' : 'Booked') : null}
            </IonButton>
