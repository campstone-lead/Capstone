      ...
      < IonPage >
        ...
        <IonContent>
          ...
          <div className="profile">
            ...
            <IonButton onClick={this.handleClick} disabled={(this.props.bookingStatus === '') ? false : true}>
              {(this.props.bookingStatus === '') ? 'Booke me' : (this.props.bookingStatus === 'pending' ? 'Pending request sent' : 'Booked')}
            </IonButton>
