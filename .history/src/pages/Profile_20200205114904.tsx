...
<IonItem href={this.props.user['instagramUrl']} target="_blank">
...
<IonItem href={this.props.user['spotifyUrl']} target="_blank">
...
<IonItem href={this.props.user['facebookUrl']} target="_blank">
