...
{/* <IonCardTitle className="textBox"> Welcome back, {this.props.user['firstName']} {this.props.user['lastName']}!</IonCardTitle> */}
<IonCardTitle className="textBox">We got you some artist you might be interested in...</IonCardTitle>

<IonCard  className="profile" style={{ "width":"300px"}}>
