...
class Tab1 extends React.Component<IMyComponentProps, IMyComponentState> {
  ...
  async componentDidMount() {
    ...
    if (this.props.user['status'] === 'booker') {
      ...
      await this.props.venues.forEach(async (venue, index) => {
  ...
  render() {
    console.log('one', this.state.recommendationsBooker, this.props.artists, this.props.venues)
    return (
      <IonPage>
        <IonHeader mode="ios"  >
          <IonToolbar mode="ios" >
          ...
          {(this.props.user['status'] === 'booker') ?
            ...
            <div className="home">
              ...
              <IonCardHeader className="home" mode="ios">
                ...
                <IonItemOptions>
                  <IonItemSliding>
                    <IonItemOption>Here</IonItemOption>
                  </IonItemSliding>
