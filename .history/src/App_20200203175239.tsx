...
render(){
  console.log(this.props.booker['id'])
  return(
  <IonApp>
    <IonReactRouter>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route path="/artisttype" component={ArtistType}/>
            {(this.props.booker['id']===undefined)?

               <Route path='/profile' component={Profile}/>:null
        ...
        <IonTabBar slot="bottom">
          ...
          <IonTabButton tab="tab3" href={(this.props.booker['id']===undefined)?'/profile':'/login'}>
            <IonIcon icon={contact} />
            <IonLabel>{(this.props.booker['id']===undefined)?'Log In':'Profile'}</IonLabel>
          </IonTabButton>
          {(this.props.booker['id']!==undefined)? <IonTabButton tab="tab2" onClick={()=>{
